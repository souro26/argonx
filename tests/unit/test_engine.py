...
from argonx.decision_rules.engine import (
    ...
    _evaluate_risk,
    _evaluate_practical_significance,
...
CONFIG = {
    ...
    "prob_best_moderate": 0.8,
    "expected_loss_max": 0.05,
    "rope_practical_min": 0.8,
    "cvar_ratio_max": 5.0,
...
class TestEngine:
    ...
    def test_guardrail_conflict_overrides(self):
        ...
        result = run_engine(
            samples, ["control", "variant_b"], "control", guardrail_samples, config
        )
    ...
    def test_missing_config(self):
        ...
        samples = np.column_stack(
            [np.array([0.4, 0.5, 0.45]), np.array([0.8, 0.9, 0.85])]
        )
